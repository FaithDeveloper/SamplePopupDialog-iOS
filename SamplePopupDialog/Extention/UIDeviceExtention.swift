...
//  TrueTrue
//
//  Created by sigong_shin on 2018. 2. 22..
...
public extension UIDevice {
    ...
    public var isiPad: Bool {
        ...
        if UIDevice.current.userInterfaceIdiom == UIUserInterfaceIdiom.pad && (UIScreen.main.bounds.size.height >= 1024 || UIScreen.main.bounds.size.width >= 1024) {
            return true
        }
        return false
    }
